...
<template>
  <div class="bg-zinc-100 border-white shadow-md border-4 rounded-[2rem] p-6">
    ...
    <div class="mt-4 flex-wrap sm:flex md:flex-row justify-start sm:justify-start lg:justify-between items-center gap-4 m">
      <div class="flex flex-wrap gap-x-2 gap-y-2">
        <span v-for="tag in post.tags" :key="tag" class="inline-flex items-center px-2.5 py-0.5 bg-[#e5e5e5] rounded-full text-xs font-medium text-gray-600">
          {{ tag }}
        </span>
      </div>
