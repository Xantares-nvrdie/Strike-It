    ...
    <div class="bg-white rounded-2xl shadow-lg p-4 sm:p-6">
        <div class="flex items-start justify-between gap-4">
            ...
            <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                    <div class="flex items-center">
                        ...
                        <span v-if="review.isCurrentUser"
            ...
            <div v-if="review.rating" class="flex items-center gap-0.5 flex-shrink-0">
                <Icon v-for="n in 5" :key="n" icon="mdi:star" class="size-4 sm:size-5"
                    :class="n <= review.rating ? 'text-yellow-400' : 'text-gray-300'" />
            </div>
        </div>

        <p class="mt-4 text-gray-700 leading-relaxed text-sm sm:text-base line-clamp-3">
            "{{ review.comment }}"
        </p>
