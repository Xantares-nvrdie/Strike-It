...
const applyVoucher = async () => {
  ...
  try {
    ...
    if (res.data.valid) {
      ...
      toast.success(
        `Voucher berhasil! Hemat Rp ${discountAmount.value.toLocaleString("id-ID")}`,
      );
    }
  } catch (error) {
  ...
  <section class="min-h-screen w-screen bg-gray-100 p-4 md:p-8 pt-24">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="flex flex-col lg:flex-row gap-8 items-start">
        <!-- Form checkout -->
        <div
          class="flex-1 w-full text-black bg-white p-6 md:p-8 rounded-2xl shadow-lg"
        >
          ...
          <form @submit.prevent="submitCheckout" class="space-y-5">
            ...
            <div class="pt-4 border-t border-gray-100">
              ...
              <div class="space-y-4">
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1"
                    >Alamat Jalan <span class="text-red-500">*</span></label
                  >
                  <input
                    type="text"
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1"
                    >Kode Pos <span class="text-red-500">*</span></label
                  >
                  <input
                    type="text"
            ...
            <div>
              ...
              <textarea
                ...
                class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                placeholder="Pesan khusus untuk kurir..."
              ></textarea>
            </div>
          </form>
        </div>
        ...
        <div class="w-full lg:w-2/5 space-y-6">
          <!-- Ringkasan pesanan -->
          <div
            class="bg-white p-6 md:p-8 rounded-2xl shadow-lg space-y-6 sticky top-24"
          >
            <h2 class="text-2xl text-black font-semibold">Pesanan Anda</h2>

            <div
              class="space-y-4 max-h-60 overflow-y-auto pr-2 custom-scrollbar"
            >
              <div
              ...
              >
                <div class="flex items-center gap-3">
                  <img
                    ...
                    class="w-14 h-14 rounded-md object-cover border border-gray-200 bg-gray-50"
                  />
                  <div>
                    <span
                      class="font-medium text-gray-800 block truncate w-40 sm:w-32"
                      :title="item.name"
                      >{{ item.name }}</span
                    >
            ...
            <div class="border-t border-gray-200 pt-4 space-y-2">
              ...
              <div
                class="flex justify-between items-center pt-2 border-t border-dashed mt-2"
              >
            ...
            <div class="border-t border-gray-200 pt-6 space-y-3">
              ...
              <div
                v-if="!isLoadingPayment && paymentMethods.length === 0"
