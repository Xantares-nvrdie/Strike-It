...
<template>
  <aside
    class="p-6 bg-white rounded-3xl shadow-lg flex flex-col gap-5 h-full max-h-[85vh] overflow-y-auto"
  >
    <div class="flex border-b border-gray-100 pb-2 mb-2">
      ...
      >
        ...
        <span
          ...
          class="bg-red-500 text-white text-[10px] px-1.5 rounded-full"
    ...
    >
      ...
      >
        ...
        <div class="flex items-center gap-4">
          <button
            type="reset"
            class="text-base font-bold text-blue-600 transition-colors hover:text-blue-700"
          >
            Hapus
          </button>
          <button
        ...
        <div class="flex items-center gap-2">
          <div class="relative flex-1">
            ...
            <Icon
              ...
              class="absolute left-2 top-1/2 -translate-y-1/2 text-gray-400 w-4 h-4"
            />
          </div>
    ...
    <div v-else class="flex flex-col h-full">
      <div
        ...
        class="flex flex-col items-center justify-center py-10 text-gray-400 flex-1"
      >
        <Icon
      ...
      <div v-else class="flex flex-col gap-4 flex-1 overflow-y-auto pr-1">
        <div
          ...
          :key="item.id"
          class="flex gap-3 bg-gray-50 p-3 rounded-xl border border-gray-100 relative group"
        >
          <img
      ...
      >
        <div class="flex justify-between items-center mb-4">
          ...
          <span class="text-lg font-bold text-gray-900"
            >Rp {{ cartTotal.toLocaleString("id-ID") }}</span
          >
        </div>
        <router-link
          to="/shop/checkout"
          class="block w-full py-3 bg-green-600 text-white text-center rounded-xl font-bold shadow-lg hover:bg-green-700 transition-transform active:scale-95"
        >
          Checkout
        </router-link>
      </div>
