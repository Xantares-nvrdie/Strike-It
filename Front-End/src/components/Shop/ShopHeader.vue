<template>
    <div class="flex flex-col items-center w-full max-w-2xl gap-2 mx-auto ">
        ...
        <nav aria-label="breadcrumb" class="w-full max-w-lg h-11 p-7 bg-white rounded-[10px] inline-flex justify-start items-center gap-1.5">
        <ol class="inline-flex items-center gap-1.5">
            <li>
                <a href="#" class="text-neutral-400 text-sm font-bold font-outfit leading-5">Home</a>
            </li>
            <li class="text-gray-500 text-sm font-bold font-outfit leading-5">/</li>
            <li>
                <a href="#" class="text-neutral-400 text-sm font-bold font-outfit leading-5">Shop</a>
            </li>
            <li class="text-gray-500 text-sm font-bold font-outfit leading-5">/</li>
        </ol>
        </nav>
        ...
        <form class="w-full max-w-lg px-5 py-2.5 bg-linear-131 from-white/20 to-gray-50/20 ">
            <div class="flex w-full max-w-lg items-end gap-2">
                ...
                <button type="submit" class="size- px-3 py-2 btn-glass rounded-xl flex justify-center items-center gap-[4.81px]">
                    <span class="text-center justify-start text-white text-[9.62px] font-normal font-['Poppins'] leading-3">Cari</span>
                </button>
            </div>
        </form>
    </div>
