    ...
    >
        ...
        <div class="mt-6 card-body flex-1 flex flex-col">
            <div class="mb-6 price flex items-baseline">
                ...
                <span class="ml-1 text-5xl font-extrabold text-gray-800">{{ price }}</span>
            ...
            <ul class="p-0 space-y-3 text-left list-none features mb-8 flex-1">
                ...
                <span class="flex-shrink-0 mr-2 text-lg" :class="isCurrent ? 'text-green-700' : 'text-green-500'">✔</span>
                <span>{{ feature }}</span>
                </li>
            </ul>
