...
<template>
  <div
    class="flex min-h-screen w-screen items-center justify-center bg-[#f5f5f5] px-4 font-['Outfit']"
  >
    <div
      class="flex w-full max-w-4xl overflow-hidden rounded-3xl bg-white shadow-2xl relative"
    >
      <div class="hidden w-1/2 bg-blue-600 md:block relative">
        ...
        <div class="absolute bottom-0 left-0 p-12 text-white z-10">
          ...
          <p class="text-blue-100 text-lg leading-relaxed">
            Temukan spot mancing terbaik dan nikmati pengalaman yang tak
            terlupakan.
          </p>
        </div>
        <div
          class="absolute inset-0 bg-gradient-to-t from-blue-900/60 to-transparent"
        ></div>
      </div>

      <div
        class="w-full p-8 md:w-1/2 md:p-12 flex flex-col justify-center relative"
      >
        <button
          @click="goToHome"
        ...
        <div class="relative mb-6 flex items-center justify-center">
          <span
            class="absolute bg-white px-2 text-xs text-gray-400 uppercase tracking-wider"
        ...
        <p class="mt-8 text-center text-sm text-gray-600">
          ...
          <button
            @click="goToRegister"
            class="font-bold text-blue-600 hover:text-blue-500 hover:underline ml-1"
          >
            Daftar Sekarang
          </button>
        </p>
