...
export default {
  ...
  getProductDetail(id) {
    // Cukup didefinisikan sekali disini
  ...
  getPaymentMethods() {
    return api.get("/payment-methods"); // Ini akan memanggil route yang baru kita buat di backend
  },
  updatePaymentMethod(id_payment_method) {
    // Menggunakan endpoint update profile yang sudah ada, tapi kirim data spesifik
